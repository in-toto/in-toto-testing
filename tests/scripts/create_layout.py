...
def main():
    ...
    key_alice = interface.import_rsa_privatekey_from_file("../keys/alice")
    ...
    key_bob = interface.import_rsa_publickey_from_file("../keys/bob.pub")
    key_carl = interface.import_rsa_publickey_from_file("../keys/carl.pub")
    key_bob["keyval"].pop("private")
    key_carl["keyval"].pop("private")
